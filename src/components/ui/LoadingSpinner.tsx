...
export function LoadingSpinner({ size = 'md', className = '' }: LoadingSpinnerProps) {
  ...
  return (
    <div className={`loader flex items-center justify-center gap-1 ${className}`}>
      <svg
      ...
      >
        <defs>
          <linearGradient id="irisGradientA" gradientUnits="userSpaceOnUse" y2="2" x2="0" y1="62" x1="0">
            <stop stopColor="var(--color-emotion)" />
            <stop offset="1" stopColor="var(--color-accent)" />
          </linearGradient>
          <linearGradient id="irisGradientB" gradientUnits="userSpaceOnUse" y2="0" x2="0" y1="64" x1="0">
            <stop stopColor="var(--color-accent)" />
            <stop offset="1" stopColor="var(--color-emotion)" />
            <animateTransform
          ...
          <linearGradient id="irisGradientC" gradientUnits="userSpaceOnUse" y2="2" x2="0" y1="62" x1="0">
            <stop stopColor="var(--color-accent-hover)" />
