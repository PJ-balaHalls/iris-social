...
function FeedbackMessage({
  ...
  const errorLabel =
    feedback.error === 'invalid-json'
      ? 'Não conseguimos interpretar as preferências.'
      : feedback.error === 'missing-columns'
        ? 'Algumas colunas ainda não existem no banco atual.'
...
export function PrivacyToolbar({
  isEditing,
  onEdit,
  onCancel,
  feedback,
...
export function PrivacyFormFooter() {
  return (
