...
import type { IrisThemeDefinition } from '@/lib/themes/themeCatalog';
  ...
  return (
    <article
      className={[
        ...
        active
          ? 'border-[var(--iris-color-primary)] bg-white shadow-[0_24px_80px_var(--iris-color-shadow)]'
          : 'border-[#E2E7E3] bg-white/58 hover:-translate-y-1 hover:bg-white',
      ].join(' ')}
    >
      <div
        ...
        style={{
          background: `
            radial-gradient(circle at 18% 18%, ${theme.preview.primary}, transparent 35%),
            radial-gradient(circle at 82% 20%, ${theme.preview.secondary}, transparent 35%),
            linear-gradient(135deg, ${theme.preview.surface}, ${theme.preview.soft})
          `,
        }}
      />
      ...
      <div className="mt-5 flex items-start justify-between gap-4">
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.18em] text-[#747D79]">
            {theme.status === 'native' ? 'Nativo' : 'Marketplace'}
          </p>
        ...
        {active ? (
          ...
          <span className="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-[#E2E7E3] bg-[#FFFDF8] text-[#747D79]">
      ...
      <button
        ...
        className={[
          ...
          active
            ? 'border border-[#DDE6DA] bg-[#FFFDF8] text-[#1B3A2E]'
