...
export default function KidsGuardianPage() {
  return (
      ...
      <div className="mx-auto w-full max-w-[1180px]">
        ...
        <section className="rounded-[38px] border border-white/70 bg-white/50 p-6 shadow-[0_32px_110px_rgba(27,58,46,0.10)] backdrop-blur-2xl sm:p-8 lg:p-10">
          ...
          <h1 className="mt-3 max-w-4xl font-display text-[2.45rem] leading-[1.02] tracking-[-0.055em] text-[#1B3A2E] sm:text-[3.4rem] lg:text-[4.1rem]">
            Supervisão, consentimento e segurança.
          </h1>

          <p className="mt-5 max-w-2xl text-base leading-7 text-[#476153]">
            Esta área será usada para responsáveis gerenciarem permissões, idade,
            privacidade e limites de uso do modo kids.
          </p>
        </section>

        <section className="mt-8 grid gap-5 md:grid-cols-3">
          {[
            ['Consentimento', 'Fluxo futuro para autorizações e vínculo do responsável.'],
            ['Privacidade', 'Controle do que pode ser salvo, exibido ou usado pela IA.'],
            ['Limites', 'Configuração futura de horários, acesso e notificações.'],
